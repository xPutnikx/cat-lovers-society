    ...
    <table>
        ...
        <g:each in="${friendsList}" status="i" var="friend">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show" id="${friend.id}">${fieldValue(bean: friend, field: "email")}</g:link></td>

                <td>${fieldValue(bean: friend, field: "firstName")}</td>

                <td>${fieldValue(bean: friend, field: "lastName")}</td>

                <td>${fieldValue(bean: friend, field: "login")}</td>

                <td>${fieldValue(bean: friend, field: "nickName")}</td>
